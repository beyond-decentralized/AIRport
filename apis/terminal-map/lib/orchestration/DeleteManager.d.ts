...
import type { IActor, AirEntity, Repository_Id } from "@airport/holding-pattern";
...
export declare type RecordsToDelete = Map<ApplicationIndex, Map<EntityId, Map<Repository_Id, AirEntity[]>>>;
