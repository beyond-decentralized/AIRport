import { DbApplication, JsonApplication } from "../Application";
import { ILinkingDictionary } from "./LinkingDictionary";
export interface IDbApplicationBuilder {
    buildDbApplicationWithoutReferences(jsonApplication: JsonApplication, relatedApplications: DbApplication[], dictionary: ILinkingDictionary): DbApplication;
