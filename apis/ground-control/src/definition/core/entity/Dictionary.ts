...
export namespace airEntity {
	...
	export const COPY_ACTOR_LID = 'COPY_ACTOR_LID'
	export const COPY_REPOSITORY_LID = 'COPY_REPOSITORY_LID'
	export const ONE_SIDE_APPLICATION_RELATION_LID = 'ONE_SIDE_APPLICATION_RELATION_LID'
	export const MANY_SIDE_APPLICATION_RELATION_LID = 'MANY_SIDE_APPLICATION_RELATION_LID'
	export const ONE_SIDE_ACTOR_LID = 'ONE_SIDE_ACTOR_LID'
	export const ONE_SIDE_REPOSITORY_LID = 'ONE_SIDE_REPOSITORY_LID'
	export const MANY_SIDE_ACTOR_LID = 'MANY_SIDE_ACTOR_LID'
	export const MANY_SIDE_REPOSITORY_LID = 'MANY_SIDE_REPOSITORY_LID'
	...
	export const SYS_WIDE_OP_ID_APPLICATION = 'airport____at_airport_slash_airport_dash_code'
