...
export namespace airEntity {
	...
	export const SOURCE_ACTOR_ID = 'SOURCE_ACTOR_LID'
	export const SOURCE_ACTOR_RECORD_ID = 'SOURCE_ACTOR_RECORD_ID'
	export const SOURCE_REPOSITORY_ID = 'SOURCE_REPOSITORY_LID'
