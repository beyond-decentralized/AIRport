...
export declare function createSelector<V1, V2, V3, V4, V, SV>(selector1: IMemoizedSelector<V1, SV>, selector2: IMemoizedSelector<V2, SV>, selector3: IMemoizedSelector<V3, SV>, selector4: IMemoizedSelector<V4, SV>, callback: (value1: V1, value2: V2, value3: V3, value4: V4) => V): IMemoizedSelector<V, SV>;
export declare function createSelector<V1, V2, V3, V4, V5, V, SV>(selector1: IMemoizedSelector<V1, SV>, selector2: IMemoizedSelector<V2, SV>, selector3: IMemoizedSelector<V3, SV>, selector4: IMemoizedSelector<V4, SV>, selector5: IMemoizedSelector<V5, SV>, callback: (value1: V1, value2: V2, value3: V3, value4: V4, value5: V5) => V): IMemoizedSelector<V, SV>;
export declare function createRootSelector<SV>(stateObservable: IObservable<SV>): IMemoizedSelector<SV, SV>;
