 ...
 */
export interface RawInsertValues<IQE extends IQEntity<any>> extends AbstractRawInsertValues<IQE> {
    columns: IQOperableField<any, any, any, any>[];
}
export interface RawInsertColumnValues<IQE extends IQEntity<any>> extends AbstractRawInsertValues<IQE> {
    columns: string[];
}
