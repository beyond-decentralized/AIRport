 ...
 */
export interface RawUpdate<IEUP extends IEntityUpdateProperties, IQE extends IQEntity<any>>
	extends AbstractRawUpdate<IQE> {
	set: IEUP;
}

export interface RawUpdateColumns<IEUC extends IEntityUpdateColumns, IQE extends IQEntity<any>>
	extends AbstractRawUpdate<IQE> {
	set: IEUC;
}
