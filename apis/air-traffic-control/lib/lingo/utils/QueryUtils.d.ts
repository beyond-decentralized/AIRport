...
import { IQEntityInternal, IQAirEntity } from "../core/entity/Entity";
...
export interface IQueryUtils {
    equals<Entity extends IAirEntity, IQ extends IQEntityInternal>(entityOrIdOrUuId: Entity | IQAirEntity | IQAirEntityRelation<Entity, IQ> | AirEntityUuId | string, toObject: any): JSONLogicalOperation;
