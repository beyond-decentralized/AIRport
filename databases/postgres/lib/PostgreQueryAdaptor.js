 ...
 */
let PostgreQueryAdaptor = class PostgreQueryAdaptor {
    constructor() {
        this.functionAdaptor = new PostgreSqlFunctionAdaptor();
    }
...
PostgreQueryAdaptor = __decorate([
    Injected()
], PostgreQueryAdaptor);
export { PostgreQueryAdaptor };
export class PostgreSqlFunctionAdaptor extends AbstractFunctionAdaptor {
...
//# sourceMappingURL=PostgreQueryAdaptor.js.map