...
let IFrameApplicationInitializer = class IFrameApplicationInitializer extends ApplicationInitializer {
    constructor() {
        super(...arguments);
...
IFrameApplicationInitializer = __decorate([
    Injected()
], IFrameApplicationInitializer);
export { IFrameApplicationInitializer };
