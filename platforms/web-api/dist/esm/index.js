...
RecordHistoryNewValue = __decorate$j([
    Entity(),
    Table()
...
RecordHistoryOldValue = __decorate$i([
    Entity(),
    Table()
...
RepositoryTransactionHistory = __decorate$h([
    Entity(),
    Table()
...
TransactionHistory = __decorate$f([
    Entity(),
    Table()
], TransactionHistory);
...
export { AIRPORT_DOMAIN, AIR_ENTITY_UTILS, API_REGISTRY, API_VALIDATOR, AUTOPILOT_API_LOADER, Actor, AirEntity, AirEntityUtils, Api, ApiObjectKind, CONTAINER_ACCESSOR, ChildContainer, Column, ConstraintMode, Container, ContainerAccessor, Context, ContextType, DEPENDENCY_INJECTION, DbAny, DbBoolean, DbDate, DbNumber, DbString, DependencyInjectionToken, Entity, GeneratedValue, INTER_APP_API_CLIENT, IOC, Id, Inject, Injected, InjectionApplication, InjectionDomain, InversionOfControl, JoinColumn, JoinColumns, Json, ManyToOne, MappedSuperclass, OneToMany, OperationHistory, Q, Q_APPLICATION, RJoinColumn, RJoinColumns, RecordHistory, RecordHistoryNewValue, RecordHistoryOldValue, Repository, RepositoryApplication, RepositoryClient, RepositoryDatabase, RepositoryTerminal, RepositoryTransactionHistory, RepositoryTransactionType, RepositoryType, RootContainer, SequenceGenerator, Table, TraditionalServerSeq, TransactionHistory, Transient, airApi, diSet, domain, duoDiSet, extend, lib, loadFrameworkApi };
