...
export default [
    {
        input: 'src/to_be_generated/airspace.runtime-index.ts',
        output: {
            sourcemap: true,
            format: 'esm',
    ...
    {
        input: "src/to_be_generated/airspace.api-index.ts",
        output: [
            {
    ...
    {
        input: "dist/app/to_be_generated/airspace.runtime-index.d.ts",
        output: [{
    ...
    },
    {
        ...
        output: [{
            file: "dist/esm/airspace.index.d.ts",
            format: "esm",
            sourcemap: true,
        }],
        plugins: [dts.default()],
