...
let RepoTransBlockSchemaToUpgrade = class RepoTransBlockSchemaToUpgrade {
};
__decorate([
    air_control_1.Id(),
...
], RepoTransBlockSchemaToUpgrade.prototype, "repositoryTransactionBlock", void 0);
__decorate([
    air_control_1.Id(),
    air_control_1.ManyToOne(),
    air_control_1.JoinColumn({ name: "SCHEMA_INDEX", referencedColumnName: "INDEX" }),
    __metadata("design:type", traffic_pattern_1.Schema)
], RepoTransBlockSchemaToUpgrade.prototype, "schema", void 0);
RepoTransBlockSchemaToUpgrade = __decorate([
    air_control_1.Entity(),
    air_control_1.Table({ name: "REPO_TRANS_BLOCK_SCHEMAS_TO_UPGRADE" })
], RepoTransBlockSchemaToUpgrade);
exports.RepoTransBlockSchemaToUpgrade = RepoTransBlockSchemaToUpgrade;
//# sourceMappingURL=RepoTransBlockSchemaToUpgrade.js.map