 ...
 */
export interface MissingRecordRepoTransBlockESelect extends IEntitySelectProperties, MissingRecordRepoTransBlockEOptionalId, MissingRecordRepoTransBlockEUpdateProperties {
 ...
 */
export interface MissingRecordRepoTransBlockECreateProperties extends MissingRecordRepoTransBlockEId, MissingRecordRepoTransBlockEUpdateProperties {
}
/**
 ...
 */
export interface QMissingRecordRepoTransBlock extends QEntity {
...
export interface QMissingRecordRepoTransBlockQRelation extends QRelation<QMissingRecordRepoTransBlock>, QMissingRecordRepoTransBlockQId {
}
