...
import { IRepoTransBlockSchemasToChange, RepoTransBlockSchemasToChangeESelect, RepoTransBlockSchemasToChangeECreateProperties, RepoTransBlockSchemasToChangeEUpdateColumns, RepoTransBlockSchemasToChangeEUpdateProperties, RepoTransBlockSchemasToChangeEId, QRepoTransBlockSchemasToChange } from './repositoryTransactionBlock/qrepotransblockschematochange';
...
import { ISharingNodeDatabase, SharingNodeDatabaseESelect, SharingNodeDatabaseECreateProperties, SharingNodeDatabaseEUpdateColumns, SharingNodeDatabaseEUpdateProperties, SharingNodeDatabaseEId, QSharingNodeDatabase } from './sharingNode/qsharingnodedatabase';
...
export interface IBaseRepoTransBlockSchemasToChangeDao extends IDao<IRepoTransBlockSchemasToChange, RepoTransBlockSchemasToChangeESelect, RepoTransBlockSchemasToChangeECreateProperties, RepoTransBlockSchemasToChangeEUpdateColumns, RepoTransBlockSchemasToChangeEUpdateProperties, RepoTransBlockSchemasToChangeEId, QRepoTransBlockSchemasToChange> {
}
export declare class BaseRepoTransBlockSchemasToChangeDao extends Dao<IRepoTransBlockSchemasToChange, RepoTransBlockSchemasToChangeESelect, RepoTransBlockSchemasToChangeECreateProperties, RepoTransBlockSchemasToChangeEUpdateColumns, RepoTransBlockSchemasToChangeEUpdateProperties, RepoTransBlockSchemasToChangeEId, QRepoTransBlockSchemasToChange> implements IBaseRepoTransBlockSchemasToChangeDao {
    constructor(utils: IUtils);
}
...
export interface IBaseSharingNodeDatabaseDao extends IDao<ISharingNodeDatabase, SharingNodeDatabaseESelect, SharingNodeDatabaseECreateProperties, SharingNodeDatabaseEUpdateColumns, SharingNodeDatabaseEUpdateProperties, SharingNodeDatabaseEId, QSharingNodeDatabase> {
}
export declare class BaseSharingNodeDatabaseDao extends Dao<ISharingNodeDatabase, SharingNodeDatabaseESelect, SharingNodeDatabaseECreateProperties, SharingNodeDatabaseEUpdateColumns, SharingNodeDatabaseEUpdateProperties, SharingNodeDatabaseEId, QSharingNodeDatabase> implements IBaseSharingNodeDatabaseDao {
    constructor(utils: IUtils);
}
