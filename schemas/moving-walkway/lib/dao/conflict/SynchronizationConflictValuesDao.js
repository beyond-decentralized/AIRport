...
let SynchronizationConflictValuesDao = class SynchronizationConflictValuesDao extends generated_1.BaseSynchronizationConflictValuesDao {
    constructor(utils) {
        super(utils);
    }
};
SynchronizationConflictValuesDao = __decorate([
    typedi_1.Service(InjectionTokens_1.SynchronizationConflictValuesDaoToken),
