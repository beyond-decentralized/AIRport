...
let SynchronizationConflictDao = class SynchronizationConflictDao extends generated_1.BaseSynchronizationConflictDao {
    constructor(utils) {
        super(utils);
    }
};
SynchronizationConflictDao = __decorate([
    typedi_1.Service(InjectionTokens_1.SynchronizationConflictDaoToken),
