...
let ApplicationPackageDao = class ApplicationPackageDao extends baseDaos_1.BaseApplicationPackageDao {
    constructor(utils) {
        super(utils);
    }
};
ApplicationPackageDao = __decorate([
    typedi_1.Service(InjectionTokens_1.ApplicationPackageDaoToken),
