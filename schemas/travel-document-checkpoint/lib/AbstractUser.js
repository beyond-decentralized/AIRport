...
let AbstractUser = class AbstractUser {
};
__decorate([
    air_control_1.Id(),
    air_control_1.GeneratedValue(),
    __metadata("design:type", Number)
], AbstractUser.prototype, "id", void 0);
__decorate([
    air_control_1.Column({ name: 'UNIQUE_IDENTIFIER' }),
    air_control_1.DbString(),
    __metadata("design:type", String)
], AbstractUser.prototype, "uniqueId", void 0);
__decorate([
    air_control_1.OneToMany(),
    __metadata("design:type", Array)
], AbstractUser.prototype, "terminals", void 0);
AbstractUser = __decorate([
