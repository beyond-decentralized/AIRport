...
export declare const NPMJS_ORG___AIRPORT_TRAFFIC_PATTERN_QSchemaToken = "NPMJS_ORG___AIRPORT_TRAFFIC_PATTERN_QSchemaToken";
export declare const NPMJS_ORG___AIRPORT_TRAFFIC_PATTERN_DaosToken: Token<NPMJS_ORG___AIRPORT_TRAFFIC_PATTERN_Daos>;
export declare const NPMJS_ORG___AIRPORT_TRAFFIC_PATTERN_DmosToken: Token<NPMJS_ORG___AIRPORT_TRAFFIC_PATTERN_Dmos>;
