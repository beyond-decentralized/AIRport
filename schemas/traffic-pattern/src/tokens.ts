...
export const NPMJS_ORG___AIRPORT_TRAFFIC_PATTERN_DAOS
	                                      = trafficPattern.token<NPMJS_ORG___AIRPORT_TRAFFIC_PATTERN_Daos>('NPMJS_ORG___AIRPORT_TRAFFIC_PATTERN_Daos')
export const NPMJS_ORG___AIRPORT_TRAFFIC_PATTERN_DUOS
	                                      = trafficPattern.token<NPMJS_ORG___AIRPORT_TRAFFIC_PATTERN_Duos>('NPMJS_ORG___AIRPORT_TRAFFIC_PATTERN_Duos')
