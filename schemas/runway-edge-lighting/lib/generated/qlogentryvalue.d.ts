 ...
 */
export interface LogEntryValueESelect extends IEntitySelectProperties, LogEntryValueEOptionalId, LogEntryValueEUpdateProperties {
 ...
 */
export interface LogEntryValueECreateProperties extends LogEntryValueEId, LogEntryValueEUpdateProperties {
}
/**
 ...
 */
export interface QLogEntryValue extends QEntity {
    id: IQNumberField;
...
export interface QLogEntryValueQRelation extends QRelation<QLogEntryValue>, QLogEntryValueQId {
}
