...
let LogEntryTypeDao = class LogEntryTypeDao extends baseDaos_1.BaseLogEntryTypeDao {
    constructor(utils) {
        super(utils);
    }
};
LogEntryTypeDao = __decorate([
    typedi_1.Service(InjectionTokens_1.LogEntryTypeDaoToken),
