...
let LogEntryValueDao = class LogEntryValueDao extends baseDaos_1.BaseLogEntryValueDao {
    constructor(utils) {
        super(utils);
    }
};
LogEntryValueDao = __decorate([
    typedi_1.Service(InjectionTokens_1.LogEntryValueDaoToken),
