...
export interface LogEntryESelect
    extends IEntitySelectProperties, LogEntryEOptionalId, LogEntryEUpdateProperties {
...
extends LogEntryEId, LogEntryEUpdateProperties {
}
...
export interface QLogEntryQRelation
	extends QRelation<QLogEntry>, QLogEntryQId {
}
