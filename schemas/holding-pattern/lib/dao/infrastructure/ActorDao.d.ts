...
export interface IActorDao extends IBaseActorDao {
    ...
    findWithDetailsByGlobalIds(uuIds: Actor_UuId[], userIds: UserId[], terminalIds: TmTerminal_Id[]): Promise<IActor[]>;
    findMapsWithDetailsByGlobalIds(uuIds: Actor_UuId[], userIds: UserId[], terminalIds: TmTerminal_Id[], actorMap: Map<UserId, Map<TmTerminal_Id, IActor>>, actorMapById: Map<Actor_Id, IActor>): Promise<void>;
