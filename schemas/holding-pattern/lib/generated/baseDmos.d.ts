...
export declare class BaseStageableDmo extends Dmo<IStageable, StageableESelect, StageableECreateProperties, StageableEUpdateProperties, StageableEId, QStageable> implements IBaseStageableDmo {
    constructor();
}
