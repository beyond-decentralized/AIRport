...
DI.db().get(AIRPORT_DATABASE).then(airDb => {
    ...
    accumulator.add(RepositoryApplication, 1);
    accumulator.add(Repository, 2);
    accumulator.add(RepositoryActor, 3);
    accumulator.add(Actor, 4);
    accumulator.add(RepoTransHistoryChangedRepositoryActor, 5);
    accumulator.add(RecordHistoryNewValue, 6);
    accumulator.add(RecordHistoryOldValue, 7);
    accumulator.add(TransactionHistory, 8);
    accumulator.add(RepositoryTransactionHistory, 9);
    accumulator.add(OperationHistory, 10);
