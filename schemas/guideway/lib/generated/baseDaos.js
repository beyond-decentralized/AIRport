...
class BaseAgtRepositoryTransactionBlockDao extends check_in_1.Dao {
    constructor(utils) {
        super(qSchema_1.Q.db.currentVersion.entityMapByName['AgtRepositoryTransactionBlock'], qSchema_1.Q, utils);
    }
}
...
class BaseRepositoryArchiveDao extends check_in_1.Dao {
    constructor(utils) {
        super(qSchema_1.Q.db.currentVersion.entityMapByName['RepositoryArchive'], qSchema_1.Q, utils);
    }
}
exports.BaseRepositoryArchiveDao = BaseRepositoryArchiveDao;
class BaseSecurityAnswerDao extends check_in_1.Dao {
    constructor(utils) {
        super(qSchema_1.Q.db.currentVersion.entityMapByName['SecurityAnswer'], qSchema_1.Q, utils);
    }
}
exports.BaseSecurityAnswerDao = BaseSecurityAnswerDao;
class BaseSecurityQuestionDao extends check_in_1.Dao {
    constructor(utils) {
        super(qSchema_1.Q.db.currentVersion.entityMapByName['SecurityQuestion'], qSchema_1.Q, utils);
    }
}
exports.BaseSecurityQuestionDao = BaseSecurityQuestionDao;
class BaseServerDao extends check_in_1.Dao {
    constructor(utils) {
        super(qSchema_1.Q.db.currentVersion.entityMapByName['Server'], qSchema_1.Q, utils);
    }
}
exports.BaseServerDao = BaseServerDao;
class BaseServerSyncLogDao extends check_in_1.Dao {
    constructor(utils) {
        super(qSchema_1.Q.db.currentVersion.entityMapByName['ServerSyncLog'], qSchema_1.Q, utils);
    }
}
exports.BaseServerSyncLogDao = BaseServerSyncLogDao;
class BaseSyncLogDao extends check_in_1.Dao {
    constructor(utils) {
        super(qSchema_1.Q.db.currentVersion.entityMapByName['SyncLog'], qSchema_1.Q, utils);
    }
}
...
class BaseTerminalRepositoryDao extends check_in_1.Dao {
    constructor(utils) {
        super(qSchema_1.Q.db.currentVersion.entityMapByName['TerminalRepository'], qSchema_1.Q, utils);
    }
}
exports.BaseTerminalRepositoryDao = BaseTerminalRepositoryDao;
class BaseTuningParametersDao extends check_in_1.Dao {
    constructor(utils) {
        super(qSchema_1.Q.db.currentVersion.entityMapByName['TuningParameters'], qSchema_1.Q, utils);
    }
}
...
class BaseUserRepositoryDao extends check_in_1.Dao {
    constructor(utils) {
        super(qSchema_1.Q.db.currentVersion.entityMapByName['UserRepository'], qSchema_1.Q, utils);
    }
}
