...
export const MAPPED_SUPERCLASS = [
	...
	},
	{
		...
		"docEntry": {
			...
			"isMappedSuperclass": true,
			"isTransient": false,
			"name": "ImmutableWithActor",
			"type": "typeof ImmutableWithActor",
			"fileImports": {
				"importMapByObjectAsName": {
					"JoinColumn": {
						"fileImports": null,
			...
			"fileImports": {
				"importMapByObjectAsName": {
					...
					"ImmutableWithActor": {
						...
						"objectMapByAsName": {
							"ImmutableWithActor": {
								"asName": "ImmutableWithActor",
								"moduleImport": null,
								"sourceName": "ImmutableWithActor"
							}
						},
						"path": "./ImmutableWithActor"
					}
				},
				"importMapByModulePath": {
					"@airport/air-control": null,
					"./ImmutableWithActor": null
				}
			},
			"properties": [
				{
	...
	},
	{
		...
		"docEntry": {
			...
			"isMappedSuperclass": true,
			"isTransient": false,
			"name": "MutableWithActor",
			"type": "typeof MutableWithActor",
			"fileImports": {
				"importMapByObjectAsName": {
					"JoinColumn": {
						"fileImports": null,
