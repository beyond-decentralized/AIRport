var app = (function (exports) {
    ...
    ContainerAccessor = __decorate$1([
        Injected()
    ], ContainerAccessor);
    ...
    */
    ...
    exports.CrossTabCommunicator = class CrossTabCommunicator {
        constructor() {
    ...
    exports.CrossTabCommunicator = __decorate([
        Injected()
    ], exports.CrossTabCommunicator);

    const vhfRadio = lib$1('vhf-radio');
    const CROSS_TAB_COMMUNCATOR = vhfRadio.token({
        class: exports.CrossTabCommunicator,
