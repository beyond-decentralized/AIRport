...
class GraphOtmMapper {
    ...
    addMtoReference(mtoStubReference, mtoEntityId, dbEntity) {
        ...
        let mtoEntityReferenceMapForEntity = this.utils.ensureChildMap(this.utils.ensureChildArray(this.mtoEntityReferenceMap, otmDbEntity.schema.index), otmDbEntity.index);
    ...
    addOtmReference(otmStubReference, otmEntityIdValue) {
        ...
        let mtoEntityReferenceMapForEntity = this.utils.ensureChildMap(this.utils.ensureChildArray(this.otmEntityReferenceMap, otmDbEntity.schema.index), otmDbEntity.index);
