...
const SQLDelete_1 = require("../query/sql/core/SQLDelete");
const SQLInsertValues_1 = require("../query/sql/core/SQLInsertValues");
const SQLUpdate_1 = require("../query/sql/core/SQLUpdate");
const EntitySQLQuery_1 = require("../query/sql/EntitySQLQuery");
const FieldSQLQuery_1 = require("../query/sql/FieldSQLQuery");
const SheetSQLQuery_1 = require("../query/sql/SheetSQLQuery");
const TreeSQLQuery_1 = require("../query/sql/TreeSQLQuery");
...
let SqlDriver = class SqlDriver {
    ...
    search(portableQuery, cachedSqlQueryId) {
        let resultsSubject = new terminal_map_1.QuerySubject(() => {
...
SqlDriver = __decorate([
    typedi_1.Service(InjectionTokens_1.StoreDriverToken),
    __param(0, typedi_1.Inject(_ => air_control_1.AirportDatabaseToken)),
    __param(1, typedi_1.Inject(_ => air_control_1.UtilsToken)),
    __param(2, typedi_1.Inject(_ => InjectionTokens_1.ActiveQueriesToken)),
