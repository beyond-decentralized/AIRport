...
export declare const APPLICATION_BUILDER: import("@airport/direction-indicator").IDependencyInjectionToken<IApplicationBuilder>;
...
export declare const APPLICATION_INITIALIZER: import("@airport/direction-indicator").IDependencyInjectionToken<IApplicationComposer>;
...
export declare const SQL_APPLICATION_BUILDER: import("@airport/direction-indicator").IDependencyInjectionToken<IApplicationBuilder>;
