...
export declare class StructuralEntityValidator implements IStructuralEntityValidator {
    validate<E>(entities: E[], operatedOnEntityIndicator: boolean[], context: IOperationContext, fromOneToMany?: boolean, parentRelationPropertyName?: any, parentRelationEntity?: any): void;
    protected validateRelationColumn<E>(dbEntity: DbEntity, dbProperty: DbProperty, dbColumn: DbColumn, isCreate: boolean, entity: E, columnValue: any, context: IOperationContext): void;
