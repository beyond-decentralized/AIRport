...
export declare class StructuralEntityValidator implements IStructuralEntityValidator {
    validate<E>(entities: E[], operatedOnEntityIndicator: boolean[], context: IOperationContext, fromOneToMany?: boolean, parentRelationPropertyName?: any, parentRelationEntity?: any): Promise<void>;
    protected validateRelationColumnAndCheckNewRepositoryNeed<E>(dbEntity: DbEntity, dbProperty: DbProperty, dbColumn: DbColumn, isCreate: boolean, entity: E, columnValue: any, context: IOperationContext): boolean;
