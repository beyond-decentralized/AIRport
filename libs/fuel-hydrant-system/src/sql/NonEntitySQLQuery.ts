			...
			case JSONClauseObjectType.FIELD:
				...
				switch (fieldJson.dt) {
					case SQLDataType.BOOLEAN:
						view[alias] = new QBooleanField(dbColumn, dbProperty, view, this.utils);
						break;
					case SQLDataType.DATE:
						view[alias] = new QDateField(dbColumn, dbProperty, view, this.utils);
						break;
					case SQLDataType.NUMBER:
						view[alias] = new QNumberField(dbColumn, dbProperty, view, this.utils);
						break;
					case SQLDataType.STRING:
						view[alias] = new QStringField(dbColumn, dbProperty, view, this.utils);
						break;
					case SQLDataType.ANY:
						view[alias] = new QUntypedField(dbColumn, dbProperty, view, this.utils);
						break;
					default:
