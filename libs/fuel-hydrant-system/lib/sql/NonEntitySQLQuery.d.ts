import { IAirportDatabase, IQEntityInternal, IUtils, JoinTreeNode, QTree } from "@airport/air-control";
...
export declare abstract class NonEntitySQLQuery<JNEQ extends JsonNonEntityQuery> extends SQLQuery<JNEQ> {
    ...
    addFieldsToView(viewJoinRelation: JSONViewJoinRelation, viewAlias: string): QTree;
    /**
     ...
     * @param fieldPrefix
     */
    addFieldsToViewForSelect(view: QTree, viewAlias: string, select: any, fieldPrefix: string, forFieldQueryAlias?: string): void;
    addFieldToViewForSelect(view: QTree, viewAlias: string, fieldPrefix: string, fieldJson: JSONClauseField, alias: string, forFieldQueryAlias?: string): boolean;
