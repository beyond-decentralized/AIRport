...
let SynchronizationOutCoordinator = class SynchronizationOutCoordinator extends AbstractCompletable_1.AbstractCompletable {
    ...
    initialize() {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.syncNodeManager.initialize();
            this.record(this.terminalStore.nodesBySyncFrequency.pipe(withLatestFrom_1.withLatestFrom(this.terminalStore.database)).subscribe(([nodesBySyncFrequency, database]) => {
                if (!database) {
                    return;
                }
    ...
    updateSyncPool(nodesBySyncFrequency, database) {
    ...
    returnToSyncPool(frequency, database) {
    ...
    scheduleSyncsForFrequency(frequency, sharingNodes, database) {
        setTimeout(() => __awaiter(this, void 0, void 0, function* () {
            yield this.synchronizationOutManager.synchronize(sharingNodes, database).then();
