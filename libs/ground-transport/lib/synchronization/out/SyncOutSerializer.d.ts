...
import { IRepository, Repository_Id, RepositoryTransactionHistory_Id } from '@airport/holding-pattern';
...
export interface ISyncOutSerializer {
    serializeMessages(sharingNodeDbMap: Map<SharingNodeId, ISharingNodeTerminal>, sharingNodeMap: Map<SharingNodeId, ISharingNode>, repoMapBySharingNodeAndRepoIds: Map<SharingNodeId, Map<Repository_Id, [
        IRepository,
        AgtRepositoryId
    ]>>, repoTransBlockDataByRepoId: Map<Repository_Id, RepositoryTransactionBlockData>, repoTransHistoryIds: Set<RepositoryTransactionHistory_Id>, terminal: ITerminal): Promise<Map<SharingNodeId, MessageFromTM>>;
}
