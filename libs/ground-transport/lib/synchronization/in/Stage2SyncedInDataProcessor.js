...
let Stage2SyncedInDataProcessor = class Stage2SyncedInDataProcessor {
    ...
    applyChangesToDb(stage1Result) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.performCreates(stage1Result.recordCreations);
            yield this.performUpdates(stage1Result.recordUpdates);
            yield this.performDeletes(stage1Result.recordDeletions);
        });
    }
    performCreates(recordCreations) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    performUpdates(recordUpdates) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.recordUpdateStageDao.insertValues(recordUpdateStage);
            // Perform the updates
            for (const [schemaIndex, updateMapForSchema] of finalUpdateMap) {
                for (const [tableIndex, updateMapForTable] of updateMapForSchema) {
                    yield this.runUpdatesForTable(schemaIndex, tableIndex, updateMapForTable);
                }
            }
            yield this.recordUpdateStageDao.delete();
        });
    }
    /**
     ...
     */
    runUpdatesForTable(schemaIndex, tableIndex, updateKeyMap) {
        return __awaiter(this, void 0, void 0, function* () {
            for (const columnValueUpdate of updateKeyMap.values()) {
                const updatedColumns = columnValueUpdate.updatedColumns;
                if (updatedColumns) {
                    yield this.recordUpdateStageDao.updateEntityWhereIds(schemaIndex, tableIndex, columnValueUpdate.recordKeyMap, updatedColumns);
                }
                // Traverse down into nested column update combinations
                yield this.runUpdatesForTable(schemaIndex, tableIndex, columnValueUpdate.childColumnUpdateKeyMap);
            }
        });
    }
    performDeletes(recordDeletions) {
        return __awaiter(this, void 0, void 0, function* () {
            for (const [schemaIndex, deletionInSchemaMap] of recordDeletions) {
                for (const [tableIndex, deletionInTableMap] of deletionInSchemaMap) {
                    ...
                    if (numClauses) {
                        yield this.airportDb.db.deleteWhere(dbEntity, {
                            deleteFrom: qEntity,
...
Stage2SyncedInDataProcessor = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof air_control_1.IAirportDatabase !== "undefined" && air_control_1.IAirportDatabase) === "function" ? _a : Object, typeof (_b = typeof moving_walkway_1.IRecordUpdateStageDao !== "undefined" && moving_walkway_1.IRecordUpdateStageDao) === "function" ? _b : Object, typeof (_c = typeof air_control_1.IUtils !== "undefined" && air_control_1.IUtils) === "function" ? _c : Object])
