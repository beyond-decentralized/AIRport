...
import { ActorRandomId, DatabaseName, DatabaseSecondId, IActor, RepositoryId, UserUniqueId } from "@airport/holding-pattern";
...
export interface ISyncInChecker {
    ...
    checkSchemasAndDataAndRecordSharingMessages(dataMessages: IDataToTM[], actorMap: Map<ActorRandomId, Map<UserUniqueId, Map<DatabaseName, Map<DatabaseSecondId, Map<UserUniqueId, IActor>>>>>, sharingNodeRepositoryMap: Map<SharingNodeId, Map<AgtRepositoryId, RepositoryId>>): Promise<[ISharingMessage[], ISharingMessage[], IDataToTM[], Set<SchemaIndex>]>;
}
