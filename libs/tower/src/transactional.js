...
function transactional(callback, keepAlive) {
    return __awaiter(this, void 0, void 0, function () {
        var storeDriver, transactionStarted, returnValue, e_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, di_1.DI.getP(ground_control_1.STORE_DRIVER)];
                case 1:
                    storeDriver = _a.sent();
                ...
                case 2:
                    _a.trys.push([2, 6, , 9]);
                    return [4 /*yield*/, storeDriver.transact(keepAlive)];
                case 3:
                    _a.sent();
                ...
                case 4:
                    returnValue = _a.sent();
                    return [4 /*yield*/, storeDriver.commit()];
                case 5:
                    _a.sent();
                    return [2 /*return*/, returnValue];
                case 6:
                    e_1 = _a.sent();
                    if (!transactionStarted) return [3 /*break*/, 8];
                    return [4 /*yield*/, storeDriver.rollback()];
                case 7:
                    _a.sent();
                    _a.label = 8;
                case 8: throw e_1;
