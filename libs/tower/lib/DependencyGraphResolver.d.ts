...
export declare class DependencyGraphResolver implements IDependencyGraphResolver {
    getEntitiesToPersist<E>(entities: E[], ctx: IOperationContext<E, IEntityCascadeGraph>, operatedOnEntityIndicator: boolean[], fromDependency?: IDependencyGraphNode<any>): IDependencyGraphNode<any>[];
