        ...
        for (const [repositoryId, repoTransHistoriesForRepo] of repoTransHistoryMapByRepositoryId) {
            ...
            for (const repoTransHistory of repoTransHistoriesForRepo) {
                ...
                for (const operationHistory of repoTransHistory.operationHistory) {
                    ...
                    const idsForEntity = ensureChildJsMap(ensureChildJsMap(changedRecordsForRepo.ids, operationHistory.entity.applicationVersion.id), operationHistory.entity.id);
