...
import { ActorId, RepositoryEntity_ActorRecordId, Repository_Id } from '@airport/holding-pattern';
...
export declare class Stage2SyncedInDataProcessor implements IStage2SyncedInDataProcessor {
     ...
     */
    performCreates(recordCreations: Map<ApplicationVersionId, Map<TableIndex, Map<Repository_Id, Map<ActorId, Map<RepositoryEntity_ActorRecordId, Map<ColumnIndex, any>>>>>>, applicationsByApplicationVersionIdMap: Map<ApplicationVersionId, IApplication>, airDb: IAirportDatabase, dbFacade: IDatabaseFacade): Promise<void>;
    performUpdates(recordUpdates: Map<ApplicationVersionId, Map<TableIndex, Map<Repository_Id, Map<ActorId, Map<RepositoryEntity_ActorRecordId, Map<ColumnIndex, RecordUpdate>>>>>>, applicationsByApplicationVersionIdMap: Map<ApplicationVersionId, IApplication>, recordUpdateStageDao: IRecordUpdateStageDao): Promise<void>;
    performDeletes(recordDeletions: Map<ApplicationVersionId, Map<TableIndex, Map<Repository_Id, Map<ActorId, Set<RepositoryEntity_ActorRecordId>>>>>, applicationsByApplicationVersionIdMap: Map<ApplicationVersionId, IApplication>, airDb: IAirportDatabase, dbFacade: IDatabaseFacade): Promise<void>;
    /**
