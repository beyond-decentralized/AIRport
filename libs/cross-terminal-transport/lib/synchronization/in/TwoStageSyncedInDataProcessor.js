...
export class TwoStageSyncedInDataProcessor {
    ...
    // dataMessagesWithInvalidData: IDataToTM[]
        ...
        const [actorMapById, existingRepoTransBlocksWithCompatibleApplicationsAndData, dataMessagesWithCompatibleApplications, sharingMessagesWithCompatibleApplicationsAndData,
        ...
        dataMessages);
        const repoTransHistoryMapByRepositoryId = await this.recordSharingMessageToHistoryRecords(sharingMessagesWithCompatibleApplicationsAndData, existingRepoTransBlocksWithCompatibleApplicationsAndData, dataMessagesWithCompatibleApplications, actorMapById, repositoryTransactionBlockDao, repoTransBlockRepoTransHistoryDao, transactionManager);
        await this.updateLocalData(repoTransHistoryMapByRepositoryId, actorMapById, applicationsByApplicationVersionIdMap, repositoryActorDao, stage1SyncedInDataProcessor, stage2SyncedInDataProcessor, synchronizationConflictDao, synchronizationConflictPendingNotificationDao);
    }
    async recordSharingMessageToHistoryRecords(sharingMessages, existingRepoTransBlocksWithCompatibleApplicationsAndData, dataMessages, actorMapById, repositoryTransactionBlockDao, repoTransBlockRepoTransHistoryDao, // TODO: figure out the type
    transactionManager) {
    ...
    async getRepoTransHistoryMapByRepoId(dataMessages, existingRepoTransBlocksWithCompatibleApplicationsAndData, actorMapById, repositoryTransactionBlockDao, repositoryTransactionHistoryDuo) {
        ...
        for (const repositoryTransactionBlock of existingRepoTransBlocksWithCompatibleApplicationsAndData) {
    ...
    async updateLocalData(repoTransHistoryMapByRepositoryId, actorMayById, applicationsByApplicationVersionIdMap, repositoryActorDao, stage1SyncedInDataProcessor, stage2SyncedInDataProcessor, synchronizationConflictDao, synchronizationConflictPendingNotificationDao) {
