import { DbSchema, JsonSchema } from "../Schema";
import { ILinkingDictionary } from "./LinkingDictionary";
export interface IDbSchemaBuilder {
    buildDbSchemaWithoutReferences(jsonSchema: JsonSchema, relatedSchemas: DbSchema[], dictionary: ILinkingDictionary): DbSchema;
