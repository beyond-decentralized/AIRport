...
export interface IParameterAliases extends IAliasMap<IQFunction<any>, Parameter> {
...
export interface IFieldColumnAliases<IQF extends IQOrderableField<IQF>> extends IAliasMap<IQOrderableField<IQF>, string> {
    entityAliases: IEntityAliases;
    getExistingAlias(field: IQOrderableField<IQF>): string;
}
